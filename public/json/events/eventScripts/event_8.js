    ...
    function updateChiTietView() {
        ...
        tabsContainer.innerHTML = `
            <div style="display: flex; gap: 10px; margin-bottom: 20px; overflow-x: auto; padding-bottom: 5px; scrollbar-width: none; -ms-overflow-style: none;">
                ...
                <button onclick="window.setHall('goc-giao-luu-mica')" style="width: 170px; padding: 8px 16px; border-radius: 20px; border: 1px solid #3b82f6; cursor: pointer; white-space: nowrap; transition: all 0.2s; outline: none; ${activeHall === 'goc-giao-luu-mica' ? 'background: #3b82f6; color: white; font-weight: bold; box-shadow: 0 4px 6px -1px rgba(59, 130, 246, 0.4);' : 'background: white; color: #3b82f6;'}">Góc MICA</button>
            </div>
        `;
                    ...
                    <table class="mica-table">
                        <thead>
                            <tr style="background-color: #f1f5f9;">
                                ...
                                <th style="width: 23%; text-align: center;">Góc MICA</th>
                            </tr>
                        </thead>
                        <tbody>
